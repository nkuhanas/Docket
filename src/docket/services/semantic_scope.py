...
def semantic_authority_scope(content: dict[str, Any], exclusions: list[str]) -> dict[str, Any]:
    ...
    parsed: OperatorChangeSetContent | ChangeSetContent = (
    ...
    def model_projection(model: BaseModel, *, resolve: bool) -> dict[str, Any]:
        ...
        for name in type(model).model_fields:
            ...
            # Patch field presence is itself semantic (absent != explicit null).
            ...
            if name.endswith("_change_id") and isinstance(value, str):
                ...
                result[name] = model_projection(value, resolve=resolve)
