...
| Awareness Gmail card has controls or an application receipt asks for approval | Inspect `presentation`, semantic candidate kind/mutation, and migration `0018` | An alpha housekeeping card survived migration, or extraction incorrectly formulated an obligation/event |
